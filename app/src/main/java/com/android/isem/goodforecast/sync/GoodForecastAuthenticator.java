...
/**
 * Manages "Authentication" to GoodForecast's backend service.  The SyncAdapter framework
 ...
 */
public class GoodForecastAuthenticator extends AbstractAccountAuthenticator {

    public GoodForecastAuthenticator(Context context) {
        super(context);
    }
