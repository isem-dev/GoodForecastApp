package com.android.isem.goodforecast.data;
...
import com.android.isem.goodforecast.data.WeatherContract.LocationEntry;
import com.android.isem.goodforecast.data.WeatherContract.WeatherEntry;

/*
    Note: This is not a complete set of tests of the GoodForecast ContentProvider, but it does test
...
public class TestProvider extends AndroidTestCase {
    ...
    */
    public void testGetType() {
        // content://com.android.isem.goodforecast.app/weather/
        String type = mContext.getContentResolver().getType(WeatherEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.android.isem.goodforecast.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);

        String testLocation = "94074";
        // content://com.android.isem.goodforecast.app/weather/94074
        ...
        // content://com.android.isem.goodforecast.app/weather/94074/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(testLocation, testDate));
        // vnd.android.cursor.item/com.android.isem.goodforecast.app/weather/1419120000
        assertEquals("Error: the WeatherEntry CONTENT_URI with location and date should return WeatherEntry.CONTENT_ITEM_TYPE",
                WeatherEntry.CONTENT_ITEM_TYPE, type);

        // content://com.android.isem.goodforecast.app/location/
        type = mContext.getContentResolver().getType(LocationEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.android.isem.goodforecast.app/location
    ...
    public void testInsertReadProvider() {
        ...
        // If this fails, your insert weather in your ContentProvider isn't calling
